...
AA3     = spl("TRP TYR PHE HIS HIH ARG LYS CYS ASP GLU ILE LEU MET ASN PRO HYP GLN SER THR VAL ALA GLY VIN BEN COP COA PAS"+dnares3+rnares3) #@#
AA1     = spl("  W   Y   F   H   H   R   K   C   D   E   I   L   M   N   P   O   Q   S   T   V   A   J   B   U   G   X   Z"+dnares1+rnares1) #@#
#AA3     = spl("TRP TYR PHE HIS HIH ARG LYS CYS ASP GLU ILE LEU MET ASN PRO HYP GLN SER THR VAL ALA GLY VIN PAS ARO"+dnares3+rnares3) #@#
#AA1     = spl("  W   Y   F   H   H   R   K   C   D   E   I   L   M   N   P   O   Q   S   T   V   A   J   B   Z   U"+dnares1+rnares1) #@#
...
class CoarseGrained:
    ...
    # Protein backbone
    bb        = "N CA C O H OXT H1 H2 H3 O1 O2"                           #@#  
    # Lipid tails
    ...
    mapping = {
        ...
        "PAS":  nsplit(bb+"OXT","CB CG OD1 OD2"), #protonated ASP, hacked based on ASP
	"COA":  nsplit(bb), #mini-linker bead
	...
	"VIN":  nsplit("CA HR1 C HN"),
	"ARO": nsplit("C O CA CD1 CD2 CE2 CE1 CZ"),
	"BEN":  nsplit("CA CD1 HD1", "CD2 HD2 CE2 HE2", "CE1 HE1 CZ"), #hacked by analogy with PHE
	"COP":  nsplit("C O CA CD1 HD1", "CD2 HD2 CE2 HE2", "CE1 HE1 CZ"),#hacked by analogy with PHE
        }
...
class martini22:
    def __init__(self):
        ...
        self.bbtyp    = {                                                                   #                 #@#
                    "ALA": spl(" C5    N0    C5    N0    N0    N0    N0    P4    P4"), # ALA specific    #@#
		    "VIN": spl(" SC4   SC4   SC4   SC4   SC4   SC4   SC4   SC4   SC4"), # REMOVE LATER
		    "BEN": spl(" SC5   SC5   SC5   SC5   SC5   SC5   SC5   SC5   SC5"), #hacked to just stick an SC5 into backbone
		    "COP": spl(" SC5   SC5   SC5   SC5   SC5   SC5   SC5   SC5   SC5"), #hacked to just stick an SC5 into backbone
		    "COA": spl(" SP3   SP3   SP3   SP3   SP3   SP3   SP3   SP3   SP3"), #linker, might be better with SP4
        ...
        self.sidechains = {
            ...
            "CYS": [spl("C5"),             [(0.310,7500)]],
            "ASP": [spl("Qa"),             [(0.320,7500)]],
	    "PAS": [spl("P3"),             [(0.320,7500)]], #protonated ASP, hacked based on ASP
            "GLU": [spl("Qa"),             [(0.400,5000)]],
            "ILE": [spl("AC1"),            [(0.310,None)]],
            "LEU": [spl("AC1"),            [(0.330,7500)]],
            "MET": [spl("C5"),             [(0.400,2500)]],
            ...
            "ALA": [],
            "GLY": [],
	    "COA": [], #linker, doesn't have sidechains
	    "VIN": [], #hacked based on ALA
	    "BEN": [spl("SC5 SC5"),    [(0.310,7500), (0.270,None), (0.270,None)],            [(150,50)],        []], #hacked based on PHE
	    "COP": [spl("SC5 SC5"),    [(0.310,7500), (0.270,None), (0.270,None)],            [(150,50)],        []], #hacked based on PHE
            }
        ...
        "TYR":     [[(0,1),(1,2),(1,3),(2,3)],             [(0,1,2),(0,1,3)], [(0,2,3,1)]], 
        "PHE":     [[(0,1),(1,2),(1,3),(2,3)],             [(0,1,2),(0,1,3)], [(0,2,3,1)]],
	"BEN":     [[(0,1),(1,2),(1,3),(2,3)],             [(0,1,2),(0,1,3)], [(0,2,3,1)]], #hacked based on PHE
	"COP":     [[(0,1),(1,2),(1,3),(2,3)],             [(0,1,2),(0,1,3)], [(0,2,3,1)]], #hacked based on PHE        
	"HIS":     [[(0,1),(1,2),(1,3),(2,3)],             [(0,1,2),(0,1,3)], [(0,2,3,1)]],
        "HIH":     [[(0,1),(1,2),(1,3),(2,3)],             [(0,1,2),(0,1,3)], [(0,2,3,1)]],
        "GLN":     [[(0,1)]],
        "ASN":     [[(0,1)]],
        ...
        "LYS":     [[(0,1),(1,2)],                         [(0,1,2)]],
        "ASP":     [[(0,1)]],
	"PAS":	   [[(0,1)]], #hacked based on 2.2 non p ASP, protonated ASP
        "GLU":     [[(0,1)]],
        "CYS":     [[(0,1)]],
        "ILE":     [[(0,1)]],
        "LEU":     [[(0,1)]],
...
class martini22p:
    def __init__(self):
	  ...
	  "PAS": [spl("P3"),             [(0.320,7500)]], #protonated ASP, hacked based on ASP
          ...
          "ALA": [],
	  "VIN": [], #hacked based on ALA
	  "ARO": [], #hacked to be just a single BB bead hopefully
	  "COA": [], #linker, doesn't have sidechains
          "BEN": [spl("SC5 SC5"),    [(0.310,7500), (0.270,None), (0.270,None)],            [(150,50)],        []], #hacked based on PHE
	  "COP": [spl("SC5 SC5"),    [(0.310,7500), (0.270,None), (0.270,None)],            [(150,50)],        []], #hacked based on PHE
          "GLY": [],
...
class elnedyn:
    ...
    # dictionary) revert to the default.                                                        
    def bbGetBead(self,r1,ss="C"):
	print "looking up bead"
	print r1
	print  self.bbBeadDictS.get(r1,self.bbBeadDictD).get(ss,self.bbBeadDictD.get(ss))                                                                  
        return self.bbBeadDictS.get(r1,self.bbBeadDictD).get(ss,self.bbBeadDictD.get(ss))                      
...
class Topology:
	...
	print "IN FROM AMINO ACID SEQUENCE"
	...
	#print isinstance(sequence, Chain)
	    ...
	    #print "sstypes :"
	    #print chain.sstypes
	    #print "length of sstypes: "
	    #print len(chain.sstypes)
...
def main(options):
	...
	#print box
	    ...
	    # This part makes a chain of the whole list of atoms, I think
